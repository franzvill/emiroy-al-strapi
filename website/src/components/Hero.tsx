      ...
      <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto">
        <div className="mb-6 animate-fade-in">
          <div className="inline-block px-6 py-2 border border-luxury-gold/30 rounded-full mb-8 backdrop-blur-sm bg-black/20">
            <span className="text-accent text-sm font-semibold tracking-[0.2em] uppercase">Swiss Precision Craftsmanship</span>
          </div>
        </div>
        
        <h1 className="font-playfair text-6xl md:text-8xl font-bold mb-8 animate-fade-in leading-tight" style={{ animationDelay: '0.2s' }}>
          Where Football Meets
          <br />
          <span className="bg-gradient-gold bg-clip-text text-transparent">Timeless Elegance</span>
        </h1>
        ...
        <p className="text-xl md:text-2xl mb-12 text-luxury-silver animate-fade-in leading-relaxed max-w-3xl mx-auto" style={{ animationDelay: '0.4s' }}>
          Each timepiece is a masterpiece, celebrating legendary clubs with Swiss precision and iconic team heritage
        </p>
